...
\fi
    ...
    \keydd           {\textasciicircum Q}{move WS to S1},Q{move window to S1},q{go to S1},{groupWS}{groupMoveWindows}{groupScreens}
    \keydd           {\textasciicircum W}{move WS to S2},W{move window to S2},w{go to S2},{groupWS}{groupMoveWindows}{groupScreens}
    \keydd          {\textasciicircum E}{move WS to S3},E{move window to S3},e{go to S3},{groupWS}{groupMoveWindows}{groupScreens}
        \keydd          {\textasciicircum R}{move WS to S4},R{move window to S4},r{go to S4},{groupWS}{groupMoveWindows}{groupScreens}
