...
\fi
    ...
    \keydd          {}{}, Y{inspect\\file},y{yank \note{3}}
    \keydd           {\textasciicircum U}{\textcolor{gray}{move up\\half page}},U{undo \note{6}},u{forward in\\history}
    \keydd          {}{}, I{:rename(app.\\after ext.)},i{back in\\history}
    \keydd          {}{}, O{:search\_next ...},o{sort}
    \keydd          {}{}, P{remote FS\\mode},p{paste \note{3}}
...
\def\blockJ{
    \makeblock{6cm}{\note{6} U*}{
      \shortcut{U} also starts the keybindings
      \begin{itemize}
    \item \shortcut{Um<key>} delete bookmark <key>
    \item \shortcut{Uv} unmark all files (clear selection)
    \item \shortcut{UV} visual unselect
    \item \shortcut{Uq} restore closed tab
    \item \shortcut{UT}/\shortcut{Ut} remove tag
    \item \shortcut{Ud}/\shortcut{Uy} uncut
      \end{itemize}
    }
}
...
\Shortunderstack{ {\protect\blockG} {\protect\blockH} {\protect\blockJ} }
